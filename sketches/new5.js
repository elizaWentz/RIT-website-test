...
function setup() {
  ...
  palette = {
    ...
    paleLine: color("#D6B784"),
    cyanLine: color("#8B8251"),
    blueLine: color("#A5A88A"),
    goldLine: color("#8C9191"),
    coralLine: color("#B06436"),
    orangeLine: color("#7F2A23"),
    shadowLine: color("#3C281A"),
